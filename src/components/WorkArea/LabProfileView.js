...
const LabProfileView = ({ selectedUser, role }) => {
  ...
  const mesgHandler = (bool, prescription) => {
    setMessage(bool);
            ...
            >
              ...
              >
                <input
                  ...
                  onChange={(e) => mesgHandler(false, false)}
                />
                <label
                  for="rm"
              ...
              >
                <input
                  ...
                  value="Prescription"
                  style={{ marginRight: 10 }}
                  onChange={(e) => mesgHandler(true, true)}
                />
                <label
                  for="rm"
                  style={{ color: colors.primary, fontWeight: "500" }}
              ...
              >
                <input
                  ...
                  name="type"
                  style={{ marginRight: 10 }}
                  onChange={(e) => mesgHandler(true, false)}
                />
                <label
                  for="rm"
                  style={{ color: colors.primary, fontWeight: "500" }}
              ...
              {message ? (
                <Appointmentdescription
                  ...
                  placeholder={
                    prescription ? "Type prescriptions" : "Type message"
                  }
                  rows="3"
